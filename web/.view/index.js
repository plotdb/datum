...
pug_mixins["css"]("/assets/lib/@plotdb/sheet/main/index.min.css");
pug_mixins["css"]("/assets/lib/@loadingio/loading.css/main/lite.min.css");
pug_html = pug_html + "\u003Cstyle type=\"text\u002Fcss\"\u003E.cell.fixed{display:flex;align-items:center;justify-content:center}\u003C\u002Fstyle\u003E\u003C\u002Fhead\u003E\u003Cbody\u003E\u003Cdiv class=\"w-1024 rwd mx-auto my-4\"\u003E\u003Cdiv class=\"aspect-ratio ratio-3by2\"\u003E\u003Cdiv class=\"root border shadow-sm rounded\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
pug_mixins["script"]("/assets/lib/@loadingio/ldquery/main/index.min.js");
pug_mixins["script"]("/assets/lib/ldview/main/index.min.js");
pug_mixins["script"]("/assets/lib/@plotdb/sheet/main/index.min.js");
pug_mixins["script"]("/assets/lib/@plotdb/datum/dev/index.min.js");
pug_html = pug_html + "\u003Cscript type=\"module\"\u003Evar ds,s,ds2,ret,db,dimension,bind,binding,ds3;ds=datum.from([[\"year\",\"category\",\"attribute\",\"value\"],[2e3,\"Online\",\"revenue\",90],[2e3,\"Offline\",\"revenue\",100],[2e3,\"Online\",\"cost\",80],[2e3,\"Offline\",\"cost\",70],[2001,\"Online\",\"revenue\",100],[2001,\"Offline\",\"revenue\",115],[2001,\"Online\",\"cost\",85],[2001,\"Offline\",\"cost\",76],[2002,\"Online\",\"revenue\",105],[2002,\"Offline\",\"revenue\",122],[2002,\"Online\",\"cost\",86],[2002,\"Offline\",\"cost\",72],[2003,\"Online\",\"revenue\",135],[2003,\"Offline\",\"revenue\",115],[2003,\"Online\",\"cost\",90],[2003,\"Offline\",\"cost\",65]]);s=new sheet({root:ld$.find(\".root\",0),data:ds.asSheet(),frozen:{row:1},fixed:{row:1}});ds2=datum.pivot(ds,{col:\"category\",joinCols:[\"year\",\"attribute\"]});console.log(\"[ds - after pivot]\",ds2);ret=datum.type.get(ds);console.log(\"[ds - type]\",ret);db=ds.asDb();ret.map(function(e,t){var n,o;n=db.head.indexOf(e.key);o=s.cell({x:n+1,y:1});return o.textContent=e.type});dimension={x:{type:\"O\",priority:1},y:{type:\"R\",priority:2},cat:{type:\"C\",priority:3}};bind=datum.type.bind(ds2,dimension);console.log(bind);s.data(datum.asSheet(ds2));binding={x:{type:\"O\",key:\"order\",offset:1980,repeat:3},c:{type:\"C\",key:\"category\",count:3,random:false},n:{type:\"N\",key:\"name\"},y:[0,1,2,3].map(function(e){return{type:\"R\",key:\"sensor-\"+e,range:[50,100]}})};ret=datum.sample.generate({count:100,binding:binding});ds3=datum.asDb(ret.raw);console.log(ret);s.data(datum.asSheet(ds3));ret=datum.type.get(ds3);console.log(ret);ret.map(function(e,t){var n,o;n=ds3.head.indexOf(e.key);o=s.cell({x:n+1,y:1});return o.textContent=e.type});\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
